                          ...
                          <tbody>
                            <tr>
                              <td style='width:216px;'>
                                <img alt='Descriptive Alt Text' height='189' src='https://64.media.tumblr.com/36d2c7b9f2cd9054ede6fc5f9103ebf9/26c1e36a17b64d59-cb/s1280x1920/4912db6e80ded8f409b769caf1a3205cb401f572.png' style='border:none;display:block;font-size:13px;height:200px;outline:none;text-decoration:none;width:100%;' width='2' />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                    ...
                    <tr>
                      <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                        <div style="color:#187272;font-family:'Droid Sans', 'Helvetica Neue', Arial, sans-serif;font-size:16px;line-height:20px;text-align:center;">
                          	<h4>Selamat datang di ebunga</h4>
                          	<p>Aktivasi akun anda terlebih dahulu<p>
                        </div>
                      </td>
                    </tr>
                    <tr>
                        ...
                        <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='border-collapse:separate;line-height:100%;width:200px;'>
                          <tr>
                            <td align='center' bgcolor='#178F8F' role='presentation' style='background-color:#178F8F;border:none;border-radius:4px;cursor:auto;padding:10px 25px;' valign='middle'>
                              <a href="https://www.malasngoding.com/kirim-email-dengan-laravel/" style="background:#178F8F;color:#ffffff;font-family:'Droid Sans', 'Helvetica Neue', Arial, sans-serif;font-size:16px;font-weight:bold;line-height:30px;margin:0;text-decoration:none;text-transform:none;" target='_blank'>
                                Activate!
                              </a>
